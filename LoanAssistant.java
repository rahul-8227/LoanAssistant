...
public class LoanAssistant extends JFrame {             //5 text feilds , 5 labels and 5 buttons
    ...
    public static void main(String[] args) {
        new LoanAssistant().setVisible(true);             //visibility of the application
    }
    public LoanAssistant() {
        setTitle("Loan Assistant");                   //title of application
        setResizable(true);
        addWindowListener(new WindowAdapter() {              //for closing of window
        ...
        Font myFont = new Font("Arial", Font.PLAIN, 16);            //font of labels
    ...
    private void computeButtonActionPerformed(ActionEvent e)         //actual computation
    {
        ...
        monthlyInterest = interest / 1200;              //  12 months and 100 of rate = 1200
        if(computePayment)
        {
    ...
    public boolean validateDecimalNumber(JTextField tf){                //if the number is decimal of not
